...
void analyze(TString input, int channel, double metCut, int nPhotons_req, int nBtagReq, bool displayKStest, bool blinded, int photonMode) {
  ...
  PlotMaker * pMaker = new PlotMaker(19712., channel, blinded, nPhotons_req);
...
void fitPhotons(TString input, int channel, double metCut, int nPhotons_req, int nBtagReq, bool displayKStest, bool blinded, int photonMode) {

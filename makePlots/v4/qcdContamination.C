...
void qcdContamination() {
  ...
  TString prefix = "/eos/uscms/store/user/bfrancis/inputs_v7/signal_contamination_";
  ...
  TFile * fData = channel.Contains("ele") ? new TFile("/eos/uscms/store/user/bfrancis/inputs_v7/SingleElectron.root") : 
    new TFile("/eos/uscms/store/user/bfrancis/inputs_v7/SingleMu.root");

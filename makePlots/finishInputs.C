...
void finishInputs() {
 ...
 h_systA_muon->Divide(h_bkg_muon_cr1);
  ...
  fDurp->cd();
  h_systA_ele->Write("systA_ele");
  h_systA_muon->Write("systA_muon");
  h_systB_ele->Write("systB_ele");
  h_systB_muon->Write("systB_muon");
  h_systC_ele->Write("systC_ele");
  h_systC_muon->Write("systC_muon");
  fDurp->Close();

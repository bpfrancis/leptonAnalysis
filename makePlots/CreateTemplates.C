...
void CreateTemplates(TString input, TString variable, int controlRegion, TString channel, Int_t nBins, Float_t xlo, Float_t xhi, Float_t metCut = -1.0, bool cutOnSigma = false, bool cutOnChHadIso = false) {
  ...
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_ttJetsHadronic.root", "ttJetsHadronic", 
					  ...
					  false, true, true);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_ttJetsSemiLep.root", "ttJetsSemiLep", 
					  ttbar_semiLep_xsec, ttbar_semiLep_xsec * 0.025, ttbar_semiLep_xsec * 0.034, ttbar_semiLep_xsec * 0.026, ttbar_semiLep_xsec * 0.026,
					  false, true, true);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_ttJetsFullLep.root", "ttJetsFullLep", 
  ...
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_W1JetsToLNu.root", "W1JetsToLNu", 
					  xsec_w1,
					  scaleUp_w1, scaleDown_w1,
					  pdf_w1, pdf_w1);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_W2JetsToLNu.root", "W2JetsToLNu", 
					  xsec_w2,
					  scaleUp_w2, scaleDown_w2,
					  pdf_w2, pdf_w2);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_W3JetsToLNu.root", "W3JetsToLNu", 
					  xsec_w3,
					  scaleUp_w3, scaleDown_w3,
					  pdf_w3, pdf_w3);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_W4JetsToLNu.root", "W4JetsToLNu", 
					  xsec_w4,
					  scaleUp_w4, scaleDown_w4,
					  pdf_w4, pdf_w4);

  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_dyJetsToLL.root", "dyJetsToLL", 
					  1177.3 * 3, 
					  5.9, 3.6, 
					  38.8, 38.8);
  ...
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_dy1JetsToLL.root", "dy1JetsToLL", 
					  xsec_dy1,
					  scaleUp_dy1, scaleDown_dy1,
					  pdf_dy1, pdf_dy1);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_dy2JetsToLL.root", "dy2JetsToLL", 
					  xsec_dy2,
					  scaleUp_dy2, scaleDown_dy2,
					  pdf_dy2, pdf_dy2);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_dy3JetsToLL.root", "dy3JetsToLL", 
					  xsec_dy3,
					  scaleUp_dy3, scaleDown_dy3,
					  pdf_dy3, pdf_dy3);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_dy4JetsToLL.root", "dy4JetsToLL", 
					  xsec_dy4,
					  scaleUp_dy4, scaleDown_dy4,
					  pdf_dy4, pdf_dy4);

  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_TBar_s.root", "TBar_s", 
					  1.76, 0.01, 0.01, 0.08, 0.08);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_TBar_t.root", "TBar_t", 
					  30.7, 0.7, 0.7, 0.9, 1.1);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_TBar_tW.root", "TBar_tW", 
					  11.1, 0.3, 0.3, 0.7, 0.7);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_T_s.root", "T_s", 
					  3.79, 0.07, 0.07, 0.13, 0.13);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_T_t.root", "T_t", 
					  56.4, 2.1, 0.3, 1.1, 1.1);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_T_tW.root", "T_tW", 
					  11.1, 0.3, 0.3, 0.7, 0.7);

  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_WW.root", "WW",
					  57.1097, 2.3, 2.3, 2.0, 2.0);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_WZ.root", "WZ",
					  32.3161, 1.3, 1.3, 1.3, 1.3);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_ZZ.root", "ZZ",
					  8.25561, 0.3, 0.3, 0.3, 0.3);
  
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_WGToLNuG.root", "WGToLNuG",
					  553.9, 0.5 * 553.9, 0.5 * 553.9, 0.5 * 553.9, 0.5 * 553.9);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_ZGToLLG.root", "ZGToLLG",
					  159.1, 0.5 * 159.1, 0.5 * 159.1, 0.5 * 159.1, 0.5 * 159.1);

  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_TTWJets.root", "TTWJets", 
					  0.232, 0.067, 0.067, 0.03, 0.03);
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_TTZJets.root", "TTZJets", 
					  0.2057, 0., 0., 0.019, 0.024);

  double ttgamma_xsec = 0.033 * 9 + 0.148 * 12 + 0.8; // 2l(NLO) + l+jets(NLO) + all_had (approx)
  loadSuccess |= tMaker->LoadMCBackground("/eos/uscms/store/user/MYUSERNAME/stopBino_inputs/signal_contamination_TTGamma.root", "TTGamma",

...
def doSigmaFitWithMatching(varName, channel, controlRegion, systematic, metCutName, output_jet, output_photon, output_purity, xlo, xhi, wjetsResults, topM3Results, dilepResults, eleFakeRateResults, axisMin, axisMax, doLogy):
    ...
    photonHist = get1DHist(inputMatched, varName+'_ttJetsHadronic_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord)
    photonHist.Add(get1DHist(inputMatched, varName+'_ttJetsFullLep_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_ttJetsSemiLep_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_ttJetsHadronic_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_ttJetsFullLep_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_ttJetsSemiLep_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    ScaleWithError(photonHist, topM3sf, topM3sfError)

    photonHist.Add(get1DHist(inputMatched, varName+'_TTGamma_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TBar_s_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TBar_t_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TBar_tW_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_T_s_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_T_t_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_T_tW_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_WW_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_WZ_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_ZZ_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TTWJets_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TTZJets_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))

    photonHist.Add(get1DHist(inputMatched, varName+'_TTGamma_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TBar_s_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TBar_t_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TBar_tW_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_T_s_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_T_t_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_T_tW_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_WW_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_WZ_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_ZZ_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TTWJets_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TTZJets_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))

    wjetsHist = get1DHist(inputMatched, varName+'_W3JetsToLNu_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord)
    wjetsHist.Add(get1DHist(inputMatched, varName+'_W4JetsToLNu_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    wjetsHist.Add(get1DHist(inputMatched, varName+'_W3JetsToLNu_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    wjetsHist.Add(get1DHist(inputMatched, varName+'_W4JetsToLNu_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    ScaleWithError(wjetsHist, wjetsSF, wjetsSFerror)
    photonHist.Add(wjetsHist)

    zHist = get1DHist(inputMatched, varName+'_dy1JetsToLL_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord)
    zHist.Add(get1DHist(inputMatched, varName+'_dy2JetsToLL_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_dy3JetsToLL_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_dy4JetsToLL_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_ZGToLLG_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_WGToLNuG_'+channel+'_'+controlRegion+metCutName+'_matchPhoton'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_dy1JetsToLL_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_dy2JetsToLL_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_dy3JetsToLL_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_dy4JetsToLL_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_ZGToLLG_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_WGToLNuG_'+channel+'_'+controlRegion+metCutName+'_matchElectron'+systName+extraWord))
    ScaleWithError(zHist, dilepSF, dilepSFerror)
    ScaleWithError(zHist, eleFakeRateSF, eleFakeRateSFerror)
    photonHist.Add(zHist)

    jetHist = get1DHist(inputMatched, varName+'_ttJetsHadronic_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord)
    jetHist.Add(get1DHist(inputMatched, varName+'_ttJetsFullLep_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_ttJetsSemiLep_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    ScaleWithError(jetHist, topM3sf, topM3sfError)

    jetHist.Add(get1DHist(inputMatched, varName+'_TTGamma_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_TBar_s_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_TBar_t_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_TBar_tW_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_T_s_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_T_t_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_T_tW_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_WW_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_WZ_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_ZZ_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_TTWJets_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_TTZJets_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))

    wjetsHist = get1DHist(inputMatched, varName+'_W3JetsToLNu_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord)
    wjetsHist.Add(get1DHist(inputMatched, varName+'_W4JetsToLNu_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    ScaleWithError(wjetsHist, wjetsSF, wjetsSFerror)
    jetHist.Add(wjetsHist)

    zHist = get1DHist(inputMatched, varName+'_dy1JetsToLL_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord)
    zHist.Add(get1DHist(inputMatched, varName+'_dy2JetsToLL_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_dy3JetsToLL_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_dy4JetsToLL_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_ZGToLLG_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_WGToLNuG_'+channel+'_'+controlRegion+metCutName+'_matchJet'+systName+extraWord))
    ScaleWithError(zHist, dilepSF, dilepSFerror)
    ScaleWithError(zHist, eleFakeRateSF, eleFakeRateSFerror)
    jetHist.Add(zHist)
...
def wigglePurity(varName, outName, channel, controlRegion, systematic, metCutName, wjetsResults, topM3Results, dilepResults, eleFakeRateResults, promptResults, nonpromptResults):
    ...
    photonHist = get1DHist(inputMatched, varName+'_ttJetsHadronic_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord)
    photonHist.Add(get1DHist(inputMatched, varName+'_ttJetsFullLep_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_ttJetsSemiLep_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_ttJetsHadronic_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_ttJetsFullLep_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_ttJetsSemiLep_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    ScaleWithError(photonHist, topM3sf, topM3sfError)

    photonHist.Add(get1DHist(inputMatched, varName+'_TTGamma_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TBar_s_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TBar_t_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TBar_tW_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_T_s_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_T_t_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_T_tW_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_WW_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_WZ_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_ZZ_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TTWJets_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TTZJets_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))

    photonHist.Add(get1DHist(inputMatched, varName+'_TTGamma_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TBar_s_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TBar_t_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TBar_tW_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_T_s_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_T_t_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_T_tW_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_WW_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_WZ_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_ZZ_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TTWJets_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    photonHist.Add(get1DHist(inputMatched, varName+'_TTZJets_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))

    wjetsHist = get1DHist(inputMatched, varName+'_W3JetsToLNu_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord)
    wjetsHist.Add(get1DHist(inputMatched, varName+'_W4JetsToLNu_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    wjetsHist.Add(get1DHist(inputMatched, varName+'_W3JetsToLNu_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    wjetsHist.Add(get1DHist(inputMatched, varName+'_W4JetsToLNu_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    ScaleWithError(wjetsHist, wjetsSF, wjetsSFerror)
    photonHist.Add(wjetsHist)

    zHist = get1DHist(inputMatched, varName+'_dy1JetsToLL_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord)
    zHist.Add(get1DHist(inputMatched, varName+'_dy2JetsToLL_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_dy3JetsToLL_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_dy4JetsToLL_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_ZGToLLG_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_WGToLNuG_'+channel+'_'+controlRegion+'_matchPhoton'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_dy1JetsToLL_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_dy2JetsToLL_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_dy3JetsToLL_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_dy4JetsToLL_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_ZGToLLG_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    zHist.Add(get1DHist(inputMatched, varName+'_WGToLNuG_'+channel+'_'+controlRegion+'_matchElectron'+systName+extraWord))
    ScaleWithError(zHist, dilepSF, dilepSFerror)
    ScaleWithError(zHist, eleFakeRateSF, eleFakeRateSFerror)
    photonHist.Add(zHist)

    jetHist = get1DHist(inputMatched, varName+'_ttJetsHadronic_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord)
    jetHist.Add(get1DHist(inputMatched, varName+'_ttJetsFullLep_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_ttJetsSemiLep_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    ScaleWithError(jetHist, topM3sf, topM3sfError)

    jetHist.Add(get1DHist(inputMatched, varName+'_TTGamma_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_TBar_s_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_TBar_t_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_TBar_tW_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_T_s_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_T_t_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_T_tW_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_WW_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_WZ_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_ZZ_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_TTWJets_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    jetHist.Add(get1DHist(inputMatched, varName+'_TTZJets_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))

    wjetsHistJets = get1DHist(inputMatched, varName+'_W3JetsToLNu_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord)
    wjetsHistJets.Add(get1DHist(inputMatched, varName+'_W4JetsToLNu_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    ScaleWithError(wjetsHistJets, wjetsSF, wjetsSFerror)
    jetHist.Add(wjetsHistJets)

    zHistJets = get1DHist(inputMatched, varName+'_dy1JetsToLL_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord)
    zHistJets.Add(get1DHist(inputMatched, varName+'_dy2JetsToLL_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    zHistJets.Add(get1DHist(inputMatched, varName+'_dy3JetsToLL_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    zHistJets.Add(get1DHist(inputMatched, varName+'_dy4JetsToLL_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    zHistJets.Add(get1DHist(inputMatched, varName+'_ZGToLLG_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
    zHistJets.Add(get1DHist(inputMatched, varName+'_WGToLNuG_'+channel+'_'+controlRegion+'_matchJet'+systName+extraWord))
